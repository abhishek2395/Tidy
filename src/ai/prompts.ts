...
//
// Mirrors worker/src/prompts.ts exactly. The duplication is intentional:
// the extension needs to call providers directly on the BYOK path without
// pulling anything from the Worker. Both files should be kept in sync;
// PROMPT_VERSION lets us detect drift.
